...
public class ActiveDirectoryAuthentication {
	public static final Logger logger = Logger.getLogger(ActiveDirectoryAuthentication.class);

	public static void main(String[] args) {
		ActiveDirectoryAuthentication authentication = new ActiveDirectoryAuthentication("corp.mahindra.com");
		try {
			boolean authResult = authentication.authenticate("mahaya-cont", "Mahindra@987");
			System.out.print("Authentication successful ? --> " + authResult);
	...
	public boolean authenticate(String username, String password) throws LoginException { // authenticate
																							// function
