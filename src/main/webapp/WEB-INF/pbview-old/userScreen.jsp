               ...
               <div class="col-12 col-md-12 col-lg-10">
                  <div class="survey-letter">
                     <div class="row">
                                 ...
                                 <div class="row">
                                    <div class="col-md-3">
                                       <div class="avatar-wrapper">
                                          <img class="profile-pic" src="assets/images/u1.png" />
                      ...
                      data-target="#update-profile">Update Profile</a>
                     <!--  <a href="javascript:void(0);" class="survey-btn" data-toggle="modal" 
                        ...
                        <div class="modal-dialog" role="document">
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 ...
                                 <h1>Hey Tejal,</h1>
                                 <h4 id="msgvalue">Your Profile is updated. You can start the Survey</h4>
